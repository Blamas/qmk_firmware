...
[_LOWER] = LAYOUT_planck_grid(
    ...
    KC_LSFT, _______, _______, _______, KC_LBRC, KC_RBRC, KC_LCBR,  KC_RCBR, _______, _______, _______,  _______,
    KC_ESC, _______ , KC_BRID, KC_BRIU, KC_ENT , KC_ENT , _______, _______,    KC_MNXT,    KC_VOLD, KC_VOLU, KC_MUTE
),
...
[_RAISE] = LAYOUT_planck_grid(
    ...
    _______, KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,  KC_NUHS, KC_NUBS, _______, OSL(_ADJUST), _______,
    _______, _______, _______, _______, KC_BSPC, KC_BSPC, _______, _______, _______, KC_PGDN, KC_PGUP, _______
),
